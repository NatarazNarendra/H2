 ...
 * 
 * import in.niraj.spring.springbootjpah2.entity.Order; import
 * in.niraj.spring.springbootjpah2.service.IOrderService;
 * 
 *//**
	 ...
	 *//*
		 ...
		 * 
		 * @WebMvcTest(OrderController.class) public class OrderControllerTest {
		 * 
		 * @Autowired private MockMvc mvc;
		 * 
		 * @MockBean private IOrderService orderService;
		 * 
		 * @Test public void getAllOrderAPI() throws Exception {
		 * 
		 * List<Order> orderList = new ArrayList<>(); Order order = new Order();
		 * order.setId("1"); order.setDescription("order_desc"); orderList.add(order);
		 * 
