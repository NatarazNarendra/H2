 ...
 * 
 * import in.niraj.spring.springbootjpah2.entity.Tutorial; import
 * in.niraj.spring.springbootjpah2.repository.TutorialRepository;
 * 
 * @RunWith(SpringRunner.class)
 * 
 * @WebMvcTest(TutorialController.class) public class TutorialControllerTests {
 * 
 * @MockBean private TutorialRepository tutorialRepository;
 * 
 * @Autowired private MockMvc mockMvc;
 * 
 * @Autowired private ObjectMapper objectMapper;
 * 
 * @Test public void shouldCreateTutorial() throws Exception { Tutorial tutorial
 * = new Tutorial(1, "Spring Boot @WebMvcTest", "Description", true);
 * 
 * mockMvc.perform(post("/api/tutorials").contentType(MediaType.
 * APPLICATION_JSON) .content(objectMapper.writeValueAsString(tutorial)))
 * .andExpect(status().isCreated()) .andDo(print()); }
 * 
 * @Test void shouldReturnTutorial() throws Exception { long id = 1L; Tutorial
 * tutorial = new Tutorial(id, "Spring Boot @WebMvcTest", "Description", true);
 * 
 ...
 * .andDo(print()); }
 * 
 * @Test void shouldReturnNotFoundTutorial() throws Exception { long id = 1L;
 * 
 * when(tutorialRepository.findById(id)).thenReturn(Optional.empty());
 * mockMvc.perform(get("/api/tutorials/{id}", id))
 * .andExpect(status().isNotFound()) .andDo(print()); }
 * 
 * @Test void shouldReturnListOfTutorials() throws Exception { List<Tutorial>
 * tutorials = new ArrayList<>( Arrays.asList(new Tutorial(1,
 * "Spring Boot @WebMvcTest 1", "Description 1", true), new Tutorial(2,
 * "Spring Boot @WebMvcTest 2", "Description 2", true), new Tutorial(3,
 * "Spring Boot @WebMvcTest 3", "Description 3", true)));
 * 
 ...
 * 
 * @Test void shouldReturnListOfTutorialsWithFilter() throws Exception {
 * List<Tutorial> tutorials = new ArrayList<>( Arrays.asList(new Tutorial(1,
 * "Spring Boot @WebMvcTest", "Description 1", true), new Tutorial(3,
 * "Spring Boot Web MVC", "Description 3", true)));
 * 
 * String title = "Boot"; MultiValueMap<String, String> paramsMap = new
 * LinkedMultiValueMap<>(); paramsMap.add("title", title);
 * 
 ...
 * 
 * @Test void shouldReturnNoContentWhenFilter() throws Exception { String title
 * = "BezKoder"; MultiValueMap<String, String> paramsMap = new
 * LinkedMultiValueMap<>(); paramsMap.add("title", title);
 * 
 ...
 * .andExpect(status().isNoContent()) .andDo(print()); }
 * 
 * @Test void shouldUpdateTutorial() throws Exception { long id = 1L;
 * 
 * Tutorial tutorial = new Tutorial(id, "Spring Boot @WebMvcTest",
 * "Description", false); Tutorial updatedtutorial = new Tutorial(id, "Updated",
 * "Updated", true);
 * 
 * when(tutorialRepository.findById(id)).thenReturn(Optional.of(tutorial));
 ...
 * .andDo(print()); }
 * 
 * @Test void shouldReturnNotFoundUpdateTutorial() throws Exception { long id =
 * 1L;
 * 
 ...
 * .andExpect(status().isNotFound()) .andDo(print()); }
 * 
 * @Test void shouldDeleteTutorial() throws Exception { long id = 1L;
 * 
 * doNothing().when(tutorialRepository).deleteById(id);
 * mockMvc.perform(delete("/api/tutorials/{id}", id))
 * .andExpect(status().isNoContent()) .andDo(print()); }
 * 
 * @Test void shouldDeleteAllTutorials() throws Exception {
 * doNothing().when(tutorialRepository).deleteAll();
 * mockMvc.perform(delete("/api/tutorials")) .andExpect(status().isNoContent())
 * .andDo(print()); } }
 */